      ...
      <div className="page">
        <div className="glow-frame fade-in-up">
          <div className="glow-inner card p-10">
            <p className="text-sm tracking-widest uppercase text-white/60">Resume</p>
            <h1 className="mt-3 text-4xl font-extrabold md:text-5xl">John Treen</h1>

            <p className="mt-3 max-w-2xl text-white/75">
              Full-Stack & ML Engineer focused on React, TypeScript, Go, PostgreSQL,
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              ...
              <div className="card p-6">
                <h2 className="text-xl font-semibold">What this resume highlights</h2>
                <ul className="mt-4 space-y-2 text-white/75">
            ...
            <div className="mt-10 overflow-hidden rounded-2xl border border-white/10 bg-white/5">
              <iframe src="/resume.pdf" title="John Treen Resume" className="h-[800px] w-full" />
            </div>
