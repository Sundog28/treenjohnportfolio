...
function NavLink({to,label}:{to:string;label:string}){
  ...
  return (
    <Link to={to} className={`px-3 py-2 rounded ${active ? "bg-white/10 text-[var(--accent)]" : "hover:bg-white/5"}`}>
      {label}
    </Link>
  );
}
...
const Icon = {
  ...
  Mail: () => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 4-8 5L4 8V6l8 5 8-5v2z"/></svg>
  )
};
